...
Local $startPath = String(@ScriptDir)
;MsgBox(0,"Debug", "test")
Func ReadPosPixel()
	$pos = MouseGetPos()
...
ControlClick('ECAT Builder', '1001', '[CLASS:WindowsForms10.EDIT.app.0.2bf8098_r13_ad1; INSTANCE:1]')
Send('{BACKSPACE}')
ControlSend('ECAT Builder','1001','[CLASS:WindowsForms10.EDIT.app.0.2bf8098_r13_ad1; INSTANCE:1]','{END}5')
Send('{NUMPADENTER}')
Sleep(300)
...
Local $toolPath = $startPath & '\' & 'MyAutoItTool.exe'
Local $path1= $startPath & '\' & 'testENI1.xml'
Local $path2 = $startPath & '\' & 'GoldenENI(Change Node ID).xml'
Local $command1 = '"1" "' & $path1 & '" "' & $path2 & '"'

;~ MsgBox(0, '', $command1)
Sleep(1500)
Local $toolRst = ShellExecuteWait ($toolPath, $command1)
